$(function() {
  ...
  new FancyGrid({
    title: 'List of states of the United States',
      ...
      defaults: {
        ...
        render: function(o) {
          ...
          if (item) {
            ...
            if (value < edgeGood[columnIndexData]) {
              color = 'rgba(220, 107, 103, ' + (value / min[columnIndexData]) + ')';
            } else {
              color = 'rgba(58, 132, 197, ' + (value / max[columnIndexData]) + ')';
            }
          }
